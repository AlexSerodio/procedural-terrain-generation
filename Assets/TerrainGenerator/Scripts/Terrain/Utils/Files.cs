namespace Terrain.Utils
{
    public class Files
    {
        ...
        {
            public const string Original = HeightmapPath + "heightmap-1";
        ...
        {
            public const string Original = HeightmapPath + "heightmap-2";
            public const string Eroded = Original + "-eroded";
            public const string Smoothed = Original + "-smoothed";
        }
        ...
        {
            public const string Original = HeightmapPath + "heightmap-3";
            public const string Eroded = Original + "-eroded";
            public const string Smoothed = Original + "-smoothed";
        }
        ...
        {
            public const string Original = HeightmapPath + "heightmap-4";
            public const string Eroded = Original + "-eroded";
            public const string Smoothed = Original + "-smoothed";
        }
    }
